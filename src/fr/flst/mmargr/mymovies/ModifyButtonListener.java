...
public class ModifyButtonListener implements View.OnClickListener{
	private ModifyMovieActivity activity;
	
	public ModifyButtonListener(ModifyMovieActivity activity){
	...
	public void onClick(View v) {
		...
		if (titleStr.equals("")) {
			...
			values.put(DictionaryOpenHelper.COLUMN_NAME_TYPE, "history");
